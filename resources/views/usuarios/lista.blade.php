...
@section('content_header')
    <h1><i class="fas fa-users mr-2" style="color:#4d70b8;"></i> Usuários Cadastrados</h1>
@stop
...
@section('content')
    ...
    <div class="card bg-white" style="background: #111827 !important; border: 1px solid #1f2d4a !important; border-radius: 12px;">
        <div class="card-header" style="border-bottom: 1px solid #1f2d4a; color: #fff;">
            <h3 class="card-title" style="font-size: 13px; letter-spacing: 1px; text-transform: uppercase; color: #4d70b8; margin: 0;">
                            ...
                            @foreach($usuarios as $user)
                                <tr style="border-bottom: 1px solid #1f2d4a;">
                                    ...
                                    <td style="vertical-align: middle; text-align: center;">
                                        <span class="badge" style="background: rgba(77, 112, 184, 0.1); color: #4d70b8; border: 1px solid rgba(77, 112, 184, 0.2); padding: 5px 10px; font-size: 11px; border-radius: 6px;">
                                            {{ $user->carros->count() ?? 0 }}
                                        </span>
                                    </td>
                                </tr>
